...
exports.drawMarkerRowCell = drawMarkerRowCell;
...
exports.prepMarkerRowCell = prepMarkerRowCell;
...
function useMappedColumns(columns, freezeColumns) {
  return _react.default.useMemo(() => columns.map((c, i) => ({ ...c,
    sourceIndex: i,
...
function drawProtectedCell(args) {
  ...
  const center = y + h / 2;
  const p = Math.cos((0, _utils.degreesToRadians)(30)) * radius;
  const q = Math.sin((0, _utils.degreesToRadians)(30)) * radius;
