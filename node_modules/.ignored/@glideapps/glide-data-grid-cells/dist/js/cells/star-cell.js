...
const EditorWrap = styled.div.withConfig({
  displayName: "star-cell__EditorWrap",
  componentId: "sc-o1c8dg-0"
})([".active{color:", ";}display:flex;align-items:center;padding:6px 0;color:", ";> *{position:relative;width:16px;height:16px;cursor:pointer;margin-right:2px;svg{width:100%;height:100%;}}"], p => p.theme.textDark, p => p.theme.textLight);
const renderer = {
