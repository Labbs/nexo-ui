 ...
 * @module
 */
export type { TextStyles, StyledText, LinkContent, InlineContent, Block, PartialBlock, BlockIdentifier, BlockPlacement, } from '../blocks/types';
 ...
 */
export interface BlockSpec<TType extends string = string, TProps extends Record<string, PropSpec> = Record<string, PropSpec>> {
    type: TType;
    propSchema: TProps;
    content: ContentType;
    canBeNested?: boolean;
